...
I am an Assistant Professor in the Department of Computer Science at <a rel="external nofollow" href="https://www.bits-pilani.ac.in/goa/index.aspx" target="_blank">BITS Pilani, Goa Campus</a>. I am also affiliated with the AI Research Centre <a rel="external nofollow" href="https://appcair.com/index.html" target="_blank">(APPCAIR)</a>. My research focuses on Neuro-Symbolic AI, Deep Learning, Graph Representation Learning, and their applications in Computational Biology. You may want to visit [this page](/interests/) for more details on my research interests.

Prior to joining BITS Pilani as faculty, I was a Postdoctoral Research Associate at the <a rel="external nofollow" href="https://www.cam.ac.uk/" target="_blank">University of Cambridge, UK</a>, where I worked with <a rel="external nofollow" href="http://sblab.uk/sbornelov.php" target="_blank">Susanne Bornelöv</a>. I was also a Postdoctoral Affiliate of Trinity College, Cambridge (I am now an alumnus of the college). Our group drove AI-centric research at the interface of genomics and life sciences, investigating codon usage, transcript stability, and other complex biological phenomena by applying advanced artificial intelligence techniques to massive genomic datasets. I focused on building state-of-the-art learning frameworks--spanning neuro-symbolic architectures and deep sequence models--that autonomously extract new biological knowledge directly from raw genomic sequences. Before Cambridge, I was a Postdoctoral Researcher at the <a rel="external nofollow" href="https://ucsd.edu/" target="_blank">University of California, San Diego</a>, where I worked with Professor <a rel="external nofollow" href="https://sites.google.com/view/debashis-sahoo/members/DebashisSahoo" target="_blank">Debashis Sahoo</a> in the <a rel="external nofollow" href="https://sites.google.com/view/debashis-sahoo/" target="_blank">Boolean Lab</a>. In the Boolean Lab, my research focused on using AI and Boolean analysis for analysing several biological datasets (RNA-seq and Single-cell RNA-seq) in the domain of cancer, inflammatory bowel disease and macrophages. 
